...
// if everything is ok, try to upload file.
    ...
    if (move_uploaded_file($_FILES["imageFile"]["tmp_name"], $target_file)) {
        ...
        $password = "jinroot"; // Change this to your database password
        $dbname = "gate_shit"; // Change this to your database name
        ...
        $sql = "INSERT INTO images (file_name, upload_time) VALUES ('$file_name', NOW())";
