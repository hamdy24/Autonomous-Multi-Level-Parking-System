...
#define RCC_TIMER1_CLK_Reset()         (RCC->APB2RSTR |= 1<<11)
#define RCC_TIMER2_CLK_Reset()         (RCC->APB1RSTR |= 1<<0)
#define RCC_TIMER3_CLK_Reset()         (RCC->APB1RSTR |= 1<<1)
#define RCC_TIMER4_CLK_Reset()         (RCC->APB1RSTR |= 1<<2)
...
#define NVIC_IRQ25_TIMER1_UP_Enable				(NVIC_ISER0 |= (1<<25))
#define NVIC_IRQ26_TIMER1_TRG_COM_Enable		(NVIC_ISER0 |= (1<<26))
#define NVIC_IRQ27_TIMER1_CC_Enable				(NVIC_ISER0 |= (1<<27))
...
#define NVIC_IRQ25_TIMER1_UP_Disable				(NVIC_ICER0 |= (1<<25))
#define NVIC_IRQ26_TIMER1_TRG_COM_Disable			(NVIC_ICER0 |= (1<<26))
#define NVIC_IRQ27_TIMER1_CC_Disable				(NVIC_ICER0 |= (1<<27))
#define NVIC_IRQ28_TIMER2_Disable					(NVIC_ICER0 |= (1<<28))
#define NVIC_IRQ29_TIMER3_Disable					(NVIC_ICER0 |= (1<<29))
#define NVIC_IRQ30_TIMER4_Disable					(NVIC_ICER0 |= (1<<30))
